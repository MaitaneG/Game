...
_Jolasa azaldu_
  1- Jolasa exekutatzean mezu batzuk agertuko dira. Lehengoa jolastea nahi duzun galdetzen du, eta bestea zein gezi klikatu behar diren azaltzen du.
  2- Jolasa hastean musika bat agertuko da. 
  3- Bi jokalarirentzako jokua da. Bola automatikoki mugituko da, 1. jokalariaren erraketa W eta S (gora/behera) teklekin mugitzen da eta 2. jokalariaren  erraketa (goi-
     gezia/behe-gezia) teklekin mugitzen da.
  4- Bola erraketa bat jotzen badu, jokalari horri puntu bat kontatuko zaio. 
  5- Bola pantaialren hondoa ikutzen badu, jolasa bukatuko da. Jokuaren musika bukatuko da, eta Game Over soinua entzungo da. 
  6- Orduan, puntuen arabera irabazlea aukeratuko da: 1. jokalaria puntu gehiago badauzka, horrek irabazten du; 2. jokalaria puntu gehiago badauka, irabazten du; eta azkenik 2. 
...
_Oharrak_ 
  1- Gure jokua netbeans-en ondo exekutatzen da, baina .jar-etatik exekutzen bada, letra tipoa eta musika ez du ondo funtzionatzen. Horregatik bideoa egiterakoan, Netbean-etik    
     egin dugu.
  2- Klase diagrama, PingPong-eko proiektuaeren klasediagrama karpetan dago.
_Aldaketak_
